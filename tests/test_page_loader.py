...
def test_download_pics(requests_mock):
    ...
    requests_mock.get('http://test.com/picture/some/beautiful/pic.png', body=open('tests/fixtures/some/beautiful/pic.png', 'rb'))
    requests_mock.get('http://test.com/picture/any/pics.jpeg', body=open('tests/fixtures/pics.jpg', 'rb'))
    ...
    with tempfile.TemporaryDirectory() as tmpdirname:
        ...
        #добавил в фикстуры путь до картинки, но не уверен, что сработает как надо (смотри pic.html)
